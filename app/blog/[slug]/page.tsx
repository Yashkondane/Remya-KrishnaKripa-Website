      ...
      <div className={`min-h-screen beige-bg text-elegant-blue ${libreBaskerville.className}`}>
        ...
        <section className="px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto">
            {/* Breadcrumb */}
            <div className="flex items-center space-x-2 text-sm text-accent-gold mb-8">
              <Link href="/" className="hover:text-elegant-blue transition-colors">
                Home
              </Link>
              <span>/</span>
              <Link href="/journal" className="hover:text-elegant-blue transition-colors">
                Journal
              </Link>
              <span>/</span>
              <span className="text-elegant-blue">{post.title}</span>
            </div>

            {/* Category and Meta */}
            <div className="flex items-center space-x-4 mb-6">
              <span className="text-sm font-semibold text-accent-gold uppercase tracking-wider bg-accent-gold/20 px-3 py-1 rounded-full">
                {post.category}
              </span>
              <span className="text-sm text-elegant-blue/70">{post.readTime}</span>
              <span className="text-sm text-elegant-blue/70">{post.publishDate}</span>
            </div>

            {/* Title */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl leading-tight mb-8 text-elegant-blue">{post.title}</h1>

            {/* Excerpt */}
            <p className="text-xl leading-relaxed text-elegant-blue/80 mb-12">{post.excerpt}</p>
          ...
          <div className="max-w-4xl mx-auto">
            <div
              className="prose prose-lg max-w-none
                prose-headings:text-accent-gold prose-headings:font-bold
                prose-p:text-elegant-blue/90 prose-p:leading-relaxed prose-p:mb-6
                prose-ul:text-elegant-blue/90 prose-li:mb-2
                prose-strong:text-accent-gold prose-strong:font-semibold
            ...
            {/* Call to Action */}
            <div className="bg-elegant-blue/5 backdrop-blur-sm rounded-2xl p-8 mt-16 text-center">
              <h3 className="text-2xl font-bold text-accent-gold mb-4">Ready to Explore Your Own Akashic Records?</h3>
              <p className="text-lg text-elegant-blue/80 mb-6 max-w-2xl mx-auto">
              ...
              <Button className="bg-accent-gold text-elegant-blue hover:bg-accent-gold/90 px-8 py-3 rounded-lg font-semibold transition-all duration-300">
                Book Your Reading
              </Button>
            </div>

            {/* Navigation to Other Posts */}
            <div className="flex flex-col md:flex-row justify-between items-center mt-16 pt-8 border-t border-accent-gold/20">
              <Link href="/journal" className="text-accent-gold hover:text-elegant-blue transition-colors mb-4 md:mb-0">
                ← Back to All Articles
              </Link>
              <div className="flex space-x-4">
                <Button
                  variant="outline"
                  className="border-accent-gold text-accent-gold hover:bg-accent-gold hover:text-elegant-blue bg-transparent"
                >
                  Share Article
                </Button>
              </div>
